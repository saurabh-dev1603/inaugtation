...
// Define report_status enum
export const reportStatusEnum = pgEnum("report_status", ["PENDING", "DONE"]);

export const users = pgTable("inauguration_users", {
    ...
    report_status: reportStatusEnum("report_status").default("PENDING").notNull(),
});
